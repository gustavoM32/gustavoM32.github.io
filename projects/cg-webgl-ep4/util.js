...
/**
 * Flatten que funciona quando v é vazio ou tem elementos do tipo "number".
 * @param {number[] | vec2[] | vec3[] | vec4[]} v
 * @return {number[]}
 */
...
/**
 * Transforma um vetor 3D em um vetor 4D, adicionando a coordenada homogênea com
 * valor 1.
 * @param {vec3} v3
 * @return {vec4}
 */
function toVec4(v3) {
    return vec4(v3[0], v3[1], v3[2], 1.0);
}
